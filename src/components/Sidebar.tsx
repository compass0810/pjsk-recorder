...
export default function Sidebar() {
  ...
  return (
    <aside className={`${isOpen ? 'w-64' : 'w-20'} min-h-screen bg-white/40 backdrop-blur-md border-r border-white/50 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.05)] relative z-10 transition-all duration-300 pointer-events-auto`}>
      ...
      <div className={`flex items-center gap-3 p-6 mb-4 transition-all ${isOpen ? 'justify-start' : 'justify-center px-0'}`}>
        <div className="w-8 h-8 rounded shrink-0 bg-gradient-to-br from-cyan-400 to-blue-500 shadow-md flex items-center justify-center text-white font-bold text-xs" title="Menu">
          ≡
        </div>
